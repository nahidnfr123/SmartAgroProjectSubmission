...
const routes = [
    ...
    {
        path: '/:usertype/survey', name: 'Survey', component: Survey, props: true,
        meta: {accessibleTo: ['agricultural-officer', 'farmer', 'retailer']},
    ...
    {
        path: '/articles/:articles_type', name: 'Articles', component: Articles, props: true,
    },
    {path: '/blogs', name: 'Blogs', component: Blogs, props: true,},
    {path: '/read/:articles_type/:post_slug', name: 'Read Article', component: ReadPostFrontEnd, props: true,},
    ...
    {
        path: '/market/order-summary', name: 'OrderSummary', component: OrderSummary,
        meta: {accessibleTo: ['developer', 'super admin', 'admin', 'retailer', 'customer', 'agricultural-officer']},
        beforeEnter: checkAbility
    },
