                ...
                <div class="row">
                    <div class="col-12">
                        <div class="benefits-thumbnail mb-50">
                            <img src="/frontend-assets/img/bg-img/2.jpg" alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-sm-4 col-lg">
                        <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="100ms">
                            <img src="/frontend-assets/img/core-img/digger.png" alt="">
                            <h5>Best Services</h5>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 col-lg">
                        <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="300ms">
                            <img src="/frontend-assets/img/core-img/windmill.png" alt="">
                    ...
                    <div class="col-12 col-sm-4 col-lg">
                        <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="500ms">
                            <img src="/frontend-assets/img/core-img/cereals.png" alt="">
                            <h5>100% Natural</h5>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-4 col-lg">
                        <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="700ms">
                            <img src="/frontend-assets/img/core-img/tractor.png" alt="">
                    ...
                    <div class="col-12 col-sm-4 col-lg">
                        <div class="single-benefits-area wow fadeInUp mb-50" data-wow-delay="900ms">
                            <img src="/frontend-assets/img/core-img/sunrise.png" alt="">
                            <h5>Organic food</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="famie-video-play mb-100">
                            <img src="/frontend-assets/img/bg-img/6.jpg" alt="">
                            <!-- Play Icon -->
