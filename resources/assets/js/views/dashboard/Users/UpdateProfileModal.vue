                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        <label for="dob">Date of birth: <span class="ml-1" v-if="dataToUpdate.dob">{{dataToUpdate.dob | dateFormatMDY()}}</span></label>
                                        ...
                                        <div v-if="errors.dob && Array.isArray(errors.dob) ? errors.dob[0] : errors.dob">
                                            <p class="text-danger mt-1">{{ errors.dob && Array.isArray(errors.dob) ? errors.dob[0] : errors.dob }}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-4">
