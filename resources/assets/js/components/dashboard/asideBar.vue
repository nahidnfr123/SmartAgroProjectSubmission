<template>
    <!-- BEGIN: Main Menu-->
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow menu-dark" data-scroll-to-active="true" data-img="/admin/app-assets/images/backgrounds/02.jpg">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="/">
                        <img class="brand-logo" alt="Chameleon admin logo" src="/admin/app-assets/images/logo/logo.png"/>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" v-if="navigationLinks.length">
                ...
                <li :class="[Link.subLinks?'has-sub':'', subIsActive(Link)?'open':'']"
                    class=" nav-item" v-for="(Link, i) in navigationLinks" :key="i" v-if="isAccessible(Link.accessibleTo)">
                    ...
                    <ul class="menu-content" v-if="Link.subLinks">
                        <li v-for="(subLink, x) in Link.subLinks" :key="x" v-if="isAccessible(subLink.accessibleTo)">
                            <router-link :to="subLink.to" class="menu-item">
                                {{ subLink.label }}
                            </router-link>
                        </li>
